 ...
 */
  ...
  public void parseHeaderTFG ( String[] parser, boolean isTrain ){
    ...
    processInputsAndOutputsTFG ( isTrain, inputsDef, outputsDef, outputAttrNames, inputAttrNames );
  ...
  void insertAttribute ( String line ){
      ...
      if ( !st.hasMoreTokens() ) { // Parsing a nominal attribute with no definition of values
            ...
            if ( type.equalsIgnoreCase("numeric") )    at.setType( Attribute.REAL ); // lo añado yo para que tome numerico como real "jcgamez"
  ...
  void processInputsAndOutputsTFG( boolean isTrain, boolean inputsDef, boolean outputsDef,
