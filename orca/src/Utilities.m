classdef Utilities < handle
    ...
    %   Original authors: Pedro Antonio GutiÃ©rrez, MarÃ­a PÃ©rez Ortiz, Javier SÃ¡nchez Monedero
    ...
    methods (Static = true)
        ...
        function logsDir = configureExperiment(expFile,dirSuffix)
            ...
            for e = 1:num_experiment
                ...
                Utilities.checkDatasets(directory, datasets, archive); % Modificado TFG añadiendo el parametro archive
                
                [train, test] = Utilities.processDirectory(directory,datasetsList,archive); % Modificado TFG añadiendo el parametro archive
